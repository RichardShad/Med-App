...
* [`src/medui/`](src/medui/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/medui/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `medui` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/medui/config.cljs) defaults to `true` in
...
```clj
(ns medui.example
  (:require [medui.config :as config])
